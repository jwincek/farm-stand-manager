...
return [
	...
	'meta_labels' => [
		'_pkit_source_name'  => [ __( 'Clay Supplier', 'producerkit' ), __( 'Where the clay or glaze came from. Falls back to the post title on the front end if left empty.', 'producerkit' ) ],
		'_pkit_source_history'    => [ __( 'Background', 'producerkit' ), __( 'The story behind this body or glaze.', 'producerkit' ) ],
		'_pkit_source_processing_notes'     => [ __( 'Preparation Notes', 'producerkit' ), __( 'How it was wedged, aged, sieved or blended.', 'producerkit' ) ],
		'_pkit_production_notes'     => [ __( 'Making Notes', 'producerkit' ), __( 'Shown on the product page. Free-form.', 'producerkit' ) ],
		'_pkit_also_appearing' => [ __( 'Also showing', 'producerkit' ), __( 'Another maker exhibiting alongside you.', 'producerkit' ) ],
	],
	'sample'      => [
		'unit'        => 'each',
		'price'       => '$38',
		'place'       => __( 'The Studio', 'producerkit' ),
		'place_blurb' => __( 'Where the work is thrown, glazed and fired.', 'producerkit' ),
	],
	'terms'       => [
		'pkit_product_type' => [ 'Mug', 'Bowl', 'Vase', 'Plate', 'Platter', 'Pitcher', 'Teapot', 'Cup', 'Planter', 'Sculpture' ],
		'pkit_event_type'   => [ 'Open Studio', 'Kiln Opening', 'Craft Fair', 'Workshop', 'Studio Sale' ],
