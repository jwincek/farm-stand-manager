...
return [
	...
	'producer_names'  => [
		'byline'     => __( 'Released by', 'producerkit' ),
		'name_label' => __( 'Artist or band name', 'producerkit' ),
	],
	'meta_labels'     => [
		'_pkit_source_name'             => [ __( 'Label', 'producerkit' ), __( 'Who released it. Falls back to the post title on the front end if left empty.', 'producerkit' ) ],
		...
		'_pkit_source_processing_notes' => [ __( 'Mastering Notes', 'producerkit' ), __( 'What was done in post — mixing, mastering, the cut.', 'producerkit' ) ],
		'_pkit_production_notes'        => [ __( 'Release Notes', 'producerkit' ), __( 'Shown on the release page. Free-form.', 'producerkit' ) ],
		'_pkit_also_appearing'          => [ __( 'Support Acts', 'producerkit' ), __( 'Who else is on the bill.', 'producerkit' ) ],
		'_pkit_doors_datetime'          => [ __( 'Doors', 'producerkit' ), __( 'When the room opens, if that is before the set.', 'producerkit' ) ],
		'_pkit_ticket_url'              => [ __( 'Tickets', 'producerkit' ), __( 'Where tickets are sold. This plugin does not sell them.', 'producerkit' ) ],
	],
	'sample'          => [
		'unit'          => 'each',
		'price'         => '$25',
		'place'         => __( 'The Practice Room', 'producerkit' ),
		// Format and product type are the same axis here: pairing them gives
		// "Colored Vinyl Cassette".
		'pair_material' => false,
		'place_blurb'   => __( 'Where the records are boxed and the merch is kept.', 'producerkit' ),
	],
	'terms'           => [
