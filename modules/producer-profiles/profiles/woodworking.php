...
return [
	...
	'producer_names' => [
		...
		'name_label' => __( 'Workshop name', 'producerkit' ),
	],
	'meta_labels'    => [
		'_pkit_source_name'             => [ __( 'Woodlot / Supplier', 'producerkit' ), __( 'Where the timber came from. Falls back to the post title on the front end if left empty.', 'producerkit' ) ],
		'_pkit_source_history'          => [ __( 'Background', 'producerkit' ), __( 'The story behind this tree or stand of timber.', 'producerkit' ) ],
		'_pkit_source_processing_notes' => [ __( 'Milling & Drying Notes', 'producerkit' ), __( 'How it was cut and seasoned — quarter-sawn, air-dried, kiln.', 'producerkit' ) ],
