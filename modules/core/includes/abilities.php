				...
				'items' => [
					...
					'properties' => [
						...
						'types'   => [
							'type'        => 'array',
							'items'       => [ 'type' => 'string' ],
							'description' => 'Product type terms.',
						],
						'seasons' => [
							'type'        => 'array',
							'items'       => [ 'type' => 'string' ],
							'description' => 'Season terms.',
						],
						'price'   => [
							'type'        => 'string',
		...
		[
			...
			'input_schema'        => [
				...
				'properties' => [
					'product_id'  => [
						'type'        => 'integer',
						'description' => 'Filter by product ID (0 = all).',
					],
					'location_id' => [
						'type'        => 'integer',
						'description' => 'Filter by location ID (0 = all).',
					],
				],
				'default'    => [],
			],
		...
		[
			...
			'input_schema'        => [
				...
				'properties' => [
					...
					'location_id'    => [
						'type'        => 'integer',
						'description' => 'Location post ID (0 = all).',
					],
					'status'         => [
						'type'        => 'string',
						'description' => 'One of: abundant, available, limited, sold_out, unavailable.',
						'enum'        => [ 'abundant', 'available', 'limited', 'sold_out', 'unavailable' ],
					],
					'quantity_note'  => [
						'type'        => 'string',
						'description' => 'Optional note like "~3 bunches left".',
					],
					'effective_date' => [
						'type'        => 'string',
						'description' => 'Date this status takes effect (YYYY-MM-DD).',
					],
					'expires_date'   => [
						'type'        => 'string',
